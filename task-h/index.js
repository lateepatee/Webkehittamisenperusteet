...
document.addEventListener("DOMContentLoaded", () => {
    ...
    form.addEventListener('submit', (ev) => {
        ...
        tsCell.className = 'px-4 py-3 text-gray-900';
        ...
        emailCell.className = 'px-4 py-3 text-gray-900';
        row.appendChild(emailCell);

        const phoneCell = document.createElement('td');
        phoneCell.textContent = phone.trim();
        phoneCell.className = 'px-4 py-3 text-gray-900';
        row.appendChild(phoneCell);

        const birthCell = document.createElement('td');
        birthCell.textContent = birthdate;
        birthCell.className = 'px-4 py-3 text-gray-900';
        row.appendChild(birthCell);

        const acceptedCell = document.createElement('td');
        acceptedCell.textContent = termsChecked ? 'Kyllä' : 'Ei';
        acceptedCell.className = 'px-4 py-3 text-center text-gray-900 font-medium';
